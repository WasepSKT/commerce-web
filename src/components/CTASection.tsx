      ...
      <section className="py-16 relative overflow-hidden" style={{ backgroundColor: '#FFFFF' }}>
        ...
        <div className="container mx-auto px-4 flex flex-col items-center text-center relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto justify-center">
            <div tabIndex={0} className="bg-white/80 rounded-2xl p-6 shadow-sm border-2 border-[#7A1316] hover:scale-105 transform transition-transform duration-200 ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7A1316]/30">
            ...
            <div tabIndex={0} className="bg-white/80 rounded-2xl p-6 shadow-sm border-2 border-[#7A1316] hover:scale-105 transform transition-transform duration-200 ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7A1316]/30">
              ...
              <p className="text-sm text-[#7A1316]/80 text-center">Tim ahli siap membantu kapan saja</p>
            </div>
          </div>
        </div>
      </section>
