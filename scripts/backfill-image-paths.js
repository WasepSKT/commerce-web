#!/usr/bin/env node
/**
 * backfill-image-paths.js
 * Plain Node (CommonJS) version of the backfill script for environments without ts-node.
 * Usage:
 *  node ./scripts/backfill-image-paths.js --apply --limit 100
 */
